    ...
    <section id="about" className="about-section section-padding">
      <div className="container">
        <div className="about-body">
          <h2 className="section-title section-title-left">About NCVPRIPG 2026</h2>
          <div className="about-text">
            <p style={{textAlign: 'justify'}}>
              The 11th National Conference on Computer Vision, Pattern Recognition, Image Processing, and Graphics (NCVPRIPG 2026) will be held at The LNM Institute of Information Technology, Jaipur, India (jointly organized with MNIT Jaipur) from July 22-24, 2026. NCVPRIPG aims to bring together researchers and practitioners from the allied areas of computer vision, graphics, image processing, and pattern recognition, in order to promote community-wide discussions of ideas that will influence and foster continued research in the field.
            </p>
